...
function ocl_rss_dashboard_widget() {
...
function ocl_custom_dashboard_widgets() {
	wp_add_dashboard_widget('ocl_rss_dashboard_widget', 'Recently on Themble (Customize on admin.php)', 'ocl_rss_dashboard_widget');
	/*
...
add_action('wp_dashboard_setup', 'ocl_custom_dashboard_widgets');


/************* CUSTOM LOGIN PAGE *****************/

// calling your own login css so you can style it 
function ocl_login_css() {
...
function ocl_login_url() { echo bloginfo('url'); }

// changing the alt text on the logo to show your site name 
function ocl_login_title() { echo get_option('blogname'); }

// calling it only on the login page
add_action('login_head', 'ocl_login_css');
add_filter('login_headerurl', 'ocl_login_url');
add_filter('login_headertitle', 'ocl_login_title');
